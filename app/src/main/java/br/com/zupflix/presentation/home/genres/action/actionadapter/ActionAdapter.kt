...
class ActionAdapter(val movies: List<MovieResults>, val favoriteClickListener: ((movie: MovieResults) -> Unit))
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ActionAdapterViewHolder {
        ...
        return ActionAdapterViewHolder(itemView, favoriteClickListener)
    }
    ...
    class ActionAdapterViewHolder(itemView: View, private val favoriteClickListener: (movie: MovieResults) -> Unit) : RecyclerView.ViewHolder(itemView) {
