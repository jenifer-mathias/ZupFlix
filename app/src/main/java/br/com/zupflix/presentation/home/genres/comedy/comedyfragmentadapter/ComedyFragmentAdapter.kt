package br.com.zupflix.presentation.home.genres.comedy.comedyfragmentadapter
...
class ComedyFragmentAdapter(val movies: List<MovieResults>)
    : RecyclerView.Adapter<ComedyFragmentAdapter.AdventureAdapterViewHolder>() {
